...
public class Recipe {
    ...
    @Expose
    private List<Recipe_steps> analyzedInstructions = null;
    ...
    public List<Recipe_steps> getAnalyzedInstructions() {
        return analyzedInstructions;
    }

    public void setAnalyzedInstructions(List<Recipe_steps> analyzedInstructions) {
